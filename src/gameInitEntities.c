...
bool iniciandoInimigos(entityState *entityState){
    ...
    // Inimigo[1]
    InitEnemy(&entityState->enemy1, AdjustPosition(221.0f, 466.0f), 100.0f, "assets/ghost.jpg");
    ...
    // Inimigo[2]
    InitEnemy(&entityState->enemy2, AdjustPosition(1370.0f, 310.0f), 80.0f, "assets/ghost.jpg");
    ...
    // Inimigo[3]
    InitEnemy(&entityState->enemy3, AdjustPosition(916.0f, 298.0f), 80.0f, "assets/ghost.jpg");
    ...
    // Inimigo[4]
    InitEnemy(&entityState->enemy4, AdjustPosition(1516.0f, 692.0f), 80.0f, "assets/ghost.jpg");
